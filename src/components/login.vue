            ...
            return {
                ...
                loginFormRules: {
                    ...
                    password: [
                        ...
                        {min: 1, max: 10, message: '密码长度为1-10位', trigger: 'blur'},
                    ],
                },
            }
        },
        methods: {
            ...
            login(formName) {
                ...
                this.$refs[formName].validate(async (valid) => {
                    if (!valid) return
                    const {data: res} = await this.$http.post('/first/login',this.$qs.stringify(this.loginForm),{headers: {'Content-Type': 'application/x-www-form-urlencoded'}})
                  console.log(res)
